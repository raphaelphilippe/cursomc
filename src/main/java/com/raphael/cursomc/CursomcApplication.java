...
import com.raphael.cursomc.domain.Pagamento;
import com.raphael.cursomc.domain.PagamentoComBoleto;
import com.raphael.cursomc.domain.PagamentoComCartao;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Produto p2 = new Produto(null, "Improssora", 800);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmil.com", "234567891", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("23568978", "659874545"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "32322300", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "45544300", cli1, c2);
